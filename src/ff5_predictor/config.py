...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "prediction": {
        ...
        "target_columns": ["Mkt-RF", "SMB", "HML", "RMW", "CMA", "Mom"],
    ...
    "models": {
        ...
        "tcn": {"channels": [64, 64, 128], "kernel_size": 3, "dropout": 0.25},
        "ft_transformer": {
            "d_model": 64,
            "n_heads": 4,
            "num_layers": 2,
